...
from ml.streamdiffusion_wrapper import StreamDiffusionWrapper

CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))


def main(
    output: str = os.path.join(CURRENT_DIR, "sample_images",),
    model_id_or_path: str = "stabilityai/sd-turbo",
    lora_dict: Optional[Dict[str, float]] = None,
    prompt: str = "pigeon wearing gold chain eating bread",
    width: int = 512,
    height: int = 512,
    ...
    model_id_or_path : str
        The name of the model to use for image generation.s
