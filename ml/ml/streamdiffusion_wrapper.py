# Modified https://github.com/cumulo-autumn/StreamDiffusion/blob/main/utils/wrapper.py
import gc
import os
...
class StreamDiffusionWrapper:
    def __init__(
        ...
        if mode == "txt2img":
            ...
            if not use_denoising_batch and (frame_buffer_size != len(t_index_list)):
                raise ValueError(
                    "Bath denoising is disabled, frame_buffer_size must match number of elements in t_index_list"
                )
